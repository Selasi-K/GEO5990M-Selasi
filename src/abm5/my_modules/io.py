...
#Checking that each row of data contains the same number of values, and returning the number of rows and columns#
  #Checking number of rows and columns
    n_rows = len(data)
    #print('n_rows',n_rows)
    n_cols0 = len(data[0])
   # print('n_cols',n_cols0)
   #Checking if there are equal number of rows and columns and printing the num 
